...
CREATE TABLE professor_disciplina (
    id_professor_disciplina SERIAL ID PRIMARY KEY,
    fk_disciplina_id_disciplina SERIAL FK,
    fk_professor_fk_servidor_fk_usuario_id_usuario SERIAL FK
);
...
ALTER TABLE professor_disciplina ADD CONSTRAINT FK_professor_disciplina_1
    FOREIGN KEY (fk_disciplina_id_disciplina, fk_disciplina_id_disciplina)
    REFERENCES disciplina (id_disciplina)
    ON DELETE CASCADE;
 
ALTER TABLE professor_disciplina ADD CONSTRAINT FK_professor_disciplina_2
    FOREIGN KEY (fk_professor_fk_servidor_fk_usuario_id_usuario, fk_professor_fk_servidor_fk_usuario_id_usuario)
    REFERENCES professor (fk_servidor_fk_usuario_id_usuario)
    ON DELETE CASCADE;